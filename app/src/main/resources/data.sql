...
ALTER TABLE doctor_available_times
    ADD CONSTRAINT fk_doctor_availabletimes_on_doctor FOREIGN KEY (doctor_id) REFERENCES doctor (id);
...
INSERT INTO doctor (email, name, password, phone, speciality) VALUES
